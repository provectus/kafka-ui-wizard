...
<div class="mockup-code text-sm mb-5 max-h-[500px] overflow-y-auto">
  <button class="btn btn-square btn-sm absolute top-3 right-5" on:click={copyToClipboard}>
  ...
  <pre class="px-6 before:mr-0">{code}</pre>
</div>
